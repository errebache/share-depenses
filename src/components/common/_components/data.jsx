export const categories = [
    { value: 'alimentation', label: 'Alimentation', image: '/images/icons/food.svg' },
    { value: 'assurance', label: 'Assurance', image: '/images/icons/insurance.svg' },
    { value: 'divertissement', label: 'Divertissement', image: '/images/icons/entertainment.svg' },
    { value: 'logement', label: 'Logement', image: '/images/icons/bed.svg' },
    { value: 'loyer & charges', label: 'Loyer & Charges', image: '/images/icons/home.svg' },
    { value: 'restaurant & cafe', label: 'Restaurant & cafee',image: '/images/icons/restaurant.svg' },
    { value: 'shopping', label: 'Shopping',image: '/images/icons/shopping.svg' },
    { value: 'sante', label: 'Santé',image: '/images/icons/health.svg' },
    { value: 'transport', label: 'Transport',image: '/images/icons/transport.svg' },
    { value: 'autre', label: 'Autre',image: '/images/icons/food.svg' },
  ];

  export const users = [
    { value: 'mouhcine', label: 'Mouhcine', image: '' },
    { value: 'youssef', label: 'Youssef', image: '' },
    { value: 'ahmed', label: 'Ahmed', image: '' },
    { value: 'imane', label: 'Imane', image: '/images/avatar/ava_6.png' },
    { value: 'mohamed', label: 'Mohamed', image: '' },
  ];
